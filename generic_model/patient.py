...
class Patient:
    ...
    def __init__(self, patient_id):
        ...
        # need to replace these static route variables with something like
        # dictionaries in order to deal with different names/number of routes,
        # eg {'probability_route_1': 0, 'route_1_patient': False}
