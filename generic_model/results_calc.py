...
class Run_Results_Calculator:
    ...
    # these need to be replaced with dynamically created variables based on
    # names and number of routes entered by user
    ...
    # AS ABOVE - THESE NEED TO BE DYNAMIC
 ...
 # A method that calculates the average queuing time for an Admissions
 # Coordinator (AC).  We can call this at the end of each run
